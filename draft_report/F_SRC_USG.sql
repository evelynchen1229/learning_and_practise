...
and D_PF.PF_NAME like 'Lexis Check % Draft' and D_USGTYPE.USGTP_TYPE = 'Views' and D_ACC_X.ACCNT_LEGCY_ID = 'CAME5023' and D_WU.ROW_WID = F_USG.WU_WID and F_USG.USGSRC_WID = D_USGSRC.ROW_WID and (F_USG.BU_PGUID in ('UK', 'Unspecified')) and D_DT.YR_MTH between '2018 / 01' and '2019 / 12' and D_WU.WU_LOGIN_ID in ('DASG@473952','GEBW@473952') ) 
group by D_DT.YR_MTH, D_ACC.ACCNT_NAME, 
--D_ACC.ROW_WID,
