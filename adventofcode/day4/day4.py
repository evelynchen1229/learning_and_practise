...
# play the game with giant squid
giant_squid = bingo_game(initial_boards)[0]

# part 1
first_bingo_board = giant_squid[0]
print(first_bingo_board)

# part 2
last_bingo_board = giant_squid[-1]
print(last_bingo_board)
