...
def basin(center_point, heightmap, basin_list = [], depth = 0):
    ...
    additional_points = [point for point in points_around_point if heightmap[point[1]][point[0]] < 9 and point not in basin_list and heightmap[point[1]][point[0]] >= center_point_height and point not in basin_list]
